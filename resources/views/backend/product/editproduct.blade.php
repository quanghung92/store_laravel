                    ...
                    <div class="row" style="margin-bottom:40px">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <select name="category" class="form-control">
                                           {{ showcate($categorys,0,'',$products->category_id) }}
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select  name="featured" class="form-control">
                                            <option @if ($products->featured==0){{ 'selected' }}

                                            @endif  value="0">Không</option>
                                            <option @if ($products->featured==1) {{ 'selected' }}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Miêu tả</label>
                                <textarea id="editor"  name="describe" style="width: 100%;height: 100px;">{{$products->describe}}</textarea>
                                </div>
